...
export function CollectionsPanel({ entities }: Props) {
  const withOutstanding = entities.filter((e) => e.period.outstanding > 0)
  const noOutstanding = entities.filter((e) => e.period.total > 0 && e.period.outstanding === 0)
              ...
              <div className="mb-3">
                <div className="flex justify-between text-xs text-gray-500 mb-1">
                  ...
                  <span className="tabular-nums font-medium text-gray-900">
                    {fmtLocal(e.period.outstanding, e.org.currency)}
                  </span>
                </div>
